...
export class Backend implements backendInterface {
    ...
    async addImage(arg0: bigint, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllImages(): Promise<Array<EventImage>> {
        if (this.processError) {
            try {
    ...
    async getImagesByCategory(arg0: bigint): Promise<Array<EventImage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getImagesByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeImage(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateCategoryDescription(arg0: bigint, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
